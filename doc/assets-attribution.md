The following is a list of assets used in the snorcoin source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://snorcointalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original snorcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/snorcoin.icns, src/qt/res/src/snorcoin.svg,
	src/qt/res/src/snorcoin.ico, src/qt/res/src/snorcoin.png,
	src/qt/res/src/snorcoin_testnet.png, docs/snorcoin_logo_doxygen.png,
