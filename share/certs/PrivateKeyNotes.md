...
unlocked to sign the Snorcoin-Qt.app bundle.
...
allowing somebody to distribute a Snorcoin-Qt.app or snorcoin-qt-setup.exe with a valid
...
that the snorcoin-qt.exe file inside the installer had not been tampered with.
