...
bool IsCanonicalSignature(const valtype &vchSig, unsigned int flags) {
    ...
    // See https://snorcointalk.org/index.php?topic=8392.msg127623#msg127623
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Snorcoin address tx, sender provides hash of pubkey, receiver provides signature and pubkey
