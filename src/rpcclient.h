...
#ifndef _SNORCOINRPC_CLIENT_H_
#define _SNORCOINRPC_CLIENT_H_ 1
...
/** Show help message for snorcoin-cli.
 ...
 *
 * @note the argument can be removed once snorcoin-cli functionality is removed from snorcoind
 */
