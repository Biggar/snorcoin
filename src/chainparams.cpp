...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("snorcoin.sipa.be", "seed.snorcoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.snorcoin.dashjr.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("snorcoin.petertodd.org", "testnet-seed.snorcoin.petertodd.org"));
