...
WORKINGDIR="/tmp/snorcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/snorcoin/Snorcoin/snorcoin-0.8.2/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/snorcoin/Snorcoin/"
VERSIONPREFIX="snorcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'snorcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[snorcoin-]<version>-[rc[0-9]] (example: snorcoin-0.7.1-rc1)"
   echo "wget output:"
